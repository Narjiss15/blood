    ...
    <div class="container">
        ...
        if($flag == 0) { // Your Own Profile       
            $postsql = "SELECT posts.post_caption, posts.post_time, users.user_firstname, users.user_lastname,
                                posts.post_public, users.user_id, users.user_gender,
                                users.user_birthdate, users.user_blood_type, 
                                posts.post_id
                        FROM posts
                        JOIN users
            ...
            $profilesql = "SELECT users.user_id, users.user_gender, users.user_blood_type, users.user_birthdate,
